...
<p>The idea is just to display people’s favorite color and explore which colors we like. The colors can be filtered based on sex, so it's nice to see the separate results for women and men. There's also a kids category, minus thirteen.</p>
